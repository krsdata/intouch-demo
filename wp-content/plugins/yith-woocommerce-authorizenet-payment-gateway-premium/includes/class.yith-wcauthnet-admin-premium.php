...
if( ! class_exists( 'YITH_WCAUTHNET_Admin_Premium' ) ) {
	...
	class YITH_WCAUTHNET_Admin_Premium extends YITH_WCAUTHNET_Admin{
		...
		public function __construct() {
			...
			$this->admin_tabs['echeck'] =  __( 'eCheck', 'yith-wcauthnet' );
		...
		public function register_pointer() {
			...
			$args[] = array(
				...
				'content'    => sprintf( '<h3> %s </h3> <p> %s </p>',
					...
					apply_filters( 'yith_wcauthnet_activated_pointer_content', __( 'In the YIT Plugins tab you can find the YITH WooCommerce Authorize.net options. From this menu, you can access all the settings of the YITH plugins activated', 'yith-wcauthnet' ) )
				),
